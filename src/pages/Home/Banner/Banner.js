            ...
            <Container>
                <Row className="g-5">
                    ...
                    <Col md="6" className="d-flex align-items-center">
                        <div>
                            <div className="w-75">
                                <Carousel interval={1800} controls={false}>
                                    <Carousel.Item>
                            ...
                            <div className="mt-4 pt-2 d-block d-md-flex">
                                ...
                                <Nav.Link href="https://drive.google.com/uc?id=1uT3gmYKwjZ2i5RFyhY--KxUahE6ft9GG&export=download" target="_blank" className="p-0 m-0 me-3 mb-2" style={{ color: '#0d6efd' }} download="AlAmin_WebDev_Resume">
                                    <Button variant="outline-primary" className="rounded-pill px-4 shadow border-2">
                                        Download Resume
                                    </Button>
                                </Nav.Link>

                                <Nav.Link href="#contact_me" className="p-0 m-0" style={{ color: '#6c757d' }}>
                                    <Button variant="outline-secondary" className="rounded-pill px-4 shadow border-2">
                                        Contact Me
                                    </Button>
                                </Nav.Link>
                            </div>
